  ...
  return (
    <div>
      <div className="container mx-auto p-20 bg-[#222630] rounded-2xl mb-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20  lg:gap-30 justify-between">
          <div className="flex flex-col gap-10">
            <h2 className="text-[#C2F800] font-[inter]">WORKOUT LIBRARY</h2>
            <h1 className="lg:text-6xl text-5xl lg:tracking-tight text-white font-bold font-[oswald] text-start">
